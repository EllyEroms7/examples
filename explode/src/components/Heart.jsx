...
Command: npx gltfjsx@6.5.3 ./public/heart.glb 
*/
  ...
  useLayoutEffect(() => {
    ...
    if (groupRef.current != null) {
      ...
      groupRef.current.children.forEach((mesh) => {
        ...
        mesh.targetPosition = mesh.originalPosition.clone().add(mesh.direction.clone().multiplyScalar(2))
      });
    }
  }, [])
    ...
    if (groupRef.current != null) {
      groupRef.current.children.forEach((mesh) => {
        ...
        mesh.position.x = THREE.MathUtils.lerp(
          ...
          easeOutCubic(scrollData.offset)
        );
